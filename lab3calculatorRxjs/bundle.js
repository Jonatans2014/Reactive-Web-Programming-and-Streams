...
const calculator$ = __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.from(button)
        .map(x => __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(x, 'click')
        .mapTo(x.textContent))
        .mergeAll()
        .merge(__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(document, 'keypress')
        .pluck('key'));
